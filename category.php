...
$posts_of_this_page = get_posts_by_category_and_by_pagination($start_from, $posts_number_per_page, $category_id);
$posts_of_this_page_number = count($posts_of_this_page);
?>
...
<div class="page">
  <div class="posts">
    <div class="posts__content">
      <?php if ($posts_of_this_page_number > 0) : ?>
